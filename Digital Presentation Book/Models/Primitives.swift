...
/// Rectangle in slide-relative coordinates (0...1). Stored as scalars so
...
/// sRGB color with 0...1 components. Avoids platform-coupled types so the
/// manifest is portable across iOS and macOS.
